...
int main()
{
	setlocale(LC_ALL, "");                              //FR : Pour les charactères accentuées


	int a,chiffre1=0,chiffre2=0,chiffre3=0,chiffre4=0,chiffre5=0;       //FR : Les variables utilsés pour ce programme
	...
	{
		std::cout<<"Ce nombre ne contient pas 5 chiffres. ";              // FR : 99999, l'utilisateur voit sa et ne peut pas voir le résultat
	}
